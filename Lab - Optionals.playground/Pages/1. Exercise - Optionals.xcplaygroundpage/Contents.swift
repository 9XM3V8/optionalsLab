...
print(userAge)
// userAge has a value of nil because the string it's taking as it's value doesn't only contain Integers. It also has a letter character, which then changes the value to nil.
/*:
 ...
 */
//The print statement informs you the value is an optional.
print(userAge!)
